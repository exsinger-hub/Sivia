...
The SBF-Mamba [overview](../../../assets/examples/sbf-mamba-fig1.png) and [mechanism](../../../assets/examples/sbf-mamba-fig2.png) remain the project examples in the README, alongside selected knowledge-base generations. They are visual anchors, not universal scientific templates or proof that the newly generalized templates have been generation-tested. Inspect them only when relevant and allowed; exclude them in a blinded SBF-Mamba design task. A source-grounded correction takes precedence over an incidental generated label or route.
